...
- 📣 **Iemand noemen met @**: typ `@` in een chat en je krijgt een lijstje met de mensen in dat gesprek; kies er een en zijn naam komt in je bericht te staan, opgelicht. Word je zelf genoemd, dan zie je dat op drie plekken: een balk bovenaan je chatlijst (*Sanne noemde je in Iedereen* — tik erop en je springt naar het bericht), een blauw `@` bij die chat in de lijst, en een aparte melding op je telefoon. Zodra je de chat opent verdwijnt het vanzelf. Namen die op elkaar lijken gaan goed: `@Tim` raakt Timo niet. **De spelleider heeft er één extra**: `@iedereen` staat bovenaan zijn keuzelijst en roept in één keer iedereen in dát gesprek op — in de infiltrantenchat dus alleen de infiltranten. Iedereen ziet dan *📣 Jelle riep iedereen op*. Spelers kunnen dit niet: typt een speler `@iedereen`, dan is het gewone tekst en gaat er niets uit
...
- 🔒 **Privacyslot** (⚙️ → *Privacyslot*): swipe je de app weg, dan legt hij er meteen een dicht scherm met een slot overheen, zodat niemand in de app-wisselaar je chats of je rol kan meelezen. Kom je terug nadat je een tijdje weg was, dan vraagt de app opnieuw je pincode en land je daarna precies terug waar je gebleven was — ook midden in een chat. Je kiest zelf wanneer: *Direct*, *Na 1 min* (standaard), *Na 5 min* of *Uit*. Een foto of filmpje kiezen telt niet mee, dus een upload wordt nooit onderbroken. **Eerlijk over de grens**: iOS maakt het plaatje voor de app-wisselaar op het moment dat je het gebaar begínt, en een webapp krijgt dat moment niet te pakken — het dichte scherm is dus het best haalbare en geen harde garantie. Het opnieuw om je pincode vragen is dat wél
...
- 🛡️ **Iedereen** — raadsels om het schild: de eerste met het goede antwoord wint (1 poging per 5 minuten). **Zodra iemand het raadt wordt de afloop voor iedereen zichtbaar**: het juiste antwoord staat op de kaart in de chat, en achter *👀 Alle inzendingen* zie je wat er allemaal geprobeerd is, van wie en hoe laat — op volgorde, dus eindigend met het winnende antwoord. Zolang een raadsel nog loopt blijft alles dicht, ook de pogingen van anderen
...
Het **privacyslot** bouwt daarop verder: na een instelbare tijd op de achtergrond vraagt de app opnieuw je pincode, en tijdens het wegswipen ligt er een dicht scherm over de app. Dat laatste is best-effort — iOS bepaalt zelf wanneer het het plaatje voor de app-wisselaar maakt en een webapp kan dat moment niet afdwingen.
